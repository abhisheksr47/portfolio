    ...
    <nav className="mb-20 flex items-center justify-between py-6">
      ...
      <div className='m-8 flex items-center justify-center gap-4 text-2xl'>
        ...
        <a href="https://drive.google.com/uc?export=download&id=1cOWB-Lc5N1VvoTQhq0fFRYtd-891QfQM">
          <button className="relative inline-flex items-center justify-center p-0.5 mb-2 me-2 overflow-hidden text-sm font-medium text-gray-900 bg-white rounded-lg group bg-gradient-to-br from-purple-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 dark:bg-gray-900">
